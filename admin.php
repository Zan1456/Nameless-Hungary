...
$language = array(
     ...
     */
    // Login
    're-authenticate' => 'Kérlek jelentkezz be',
    ...
    // Overview
    'running_nameless_version' => 'NamelessMC verzió fut <strong>{x}</strong>', // Don't replace "{x}"
    'running_php_version' => 'PHP verzió fut <strong>{x}</strong>', // Don't replace "{x}"
    'statistics' => 'Statisztika',
    'registrations' => 'Regisztrációk',
    'topics' => 'Témák',
    'posts' => 'Hozzászólások',
    'notices' => 'Közlemények',
    'no_notices' => 'Nincsenek értesítések.',
    'email_errors_logged' => 'Az e-mail hibák naplózásra kerültek',
    ...
    'default_language_help' => 'A felhasználók bármelyik telepített nyelv közül választhatnak.',
    'install_language' => 'Új nyelv telepítése',
    'update_user_languages' => 'Frissítse a felhasználói nyelveket',
    'update_user_languages_warning' => 'Ez frissíti a webhely összes felhasználójának nyelvét, még akkor is, ha már kiválasztottak egyet!',
    'updated_user_languages' => 'A felhasználói nyelveket frissítettük.',
    'installed_languages' => 'Minden új nyelv telepítése sikeres volt.',
    'default_timezone' => 'Alapértelmezett időzóna',
    'registration' => 'Regisztráció',
    'enable_registration' => 'Engedélyezi a regisztrációt?',
    'verify_with_mcassoc' => 'Ellenőrizze a felhasználói fiókokat az MCAssoc segítségével?',
    'email_verification' => 'Engedélyezi az e-mail-ellenőrzést?',
    'registration_settings_updated' => 'A regisztrációs beállítások sikeresen frissítve.',
    'homepage_type' => 'Honlap típusa',
    'post_formatting_type' => 'Hozzászólás formázás típusa',
    'portal' => 'Portál',
    'private_profiles' => 'Privát profilok',
    'missing_sitename' => 'Kérjük, helyezzen be egy webhelynevet 2 és 64 karakter között.',
    'missing_contact_address' => 'Kérjük, írjon be egy kapcsolattartási e-mail címet 3 és 255 karakter között.',
    'use_friendly_urls' => 'Barátságos URL-ek',
    'use_friendly_urls_help' => 'FONTOS: A kiszolgálót úgy kell beállítani, hogy engedélyezze a mod_rewrite és .htaccess fájlok használatát.',
    'config_not_writable' => 'A <strong> core / config.php </strong> fájl nem írható. Kérjük, ellenőrizze a fájl engedélyeit.',
    'settings_updated_successfully' => 'Az általános beállítások frissítése sikeresen megtörtént.',
    'social_media' => 'Social Media',
    'youtube_url' => 'Youtube URL',
    'twitter_url' => 'Twitter URL',
    'twitter_dark_theme' => 'Használja a Twitter sötét témát?',
    'dark' => 'Sötét',
    'light' => 'Világos',
    'facebook_url' => 'Facebook URL',
    'social_media_settings_updated' => 'A közösségi média beállításainak frissítése sikeresen megtörtént.',
    'successfully_updated' => 'Sikeresen frissítve',
    'debugging_and_maintenance' => 'Hibakeresés és karbantartás',
    'maintenance' => 'Karbantartás',
    'debugging_settings_updated_successfully' => 'A hibakeresési beállítások sikeresen frissítve.',
    'enable_debug_mode' => 'Engedélyezi a hibakeresési módot?',
    'force_https' => 'Kényszeríteni a https-t?',
    'force_https_help' => 'Ha engedélyezve van, a webhelyére érkező összes kérelem átirányításra kerül a https-re. A megfelelő működéshez érvényes SSL-tanúsítvánnyal kell rendelkeznie.',
    'force_www' => 'Kényszeríteni a www-t?',
    'contact_email_address' => 'Kapcsolattartási email cím',
    'emails' => 'E-mailek',
    'email_errors' => 'E-mail hibák',
    'registration_email' => 'Regisztrációs e-mail',
    'contact_email' => 'Kapcsolattartó e-mail',
    'forgot_password_email' => 'Elfelejtett jelszó e-mail',
    'unknown' => 'Ismeretlen',
